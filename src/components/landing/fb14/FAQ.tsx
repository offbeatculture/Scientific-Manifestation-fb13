...
const faqs = [
  { q: "How is this relevant to my career?", a: "Your career is one of the most direct reflections of your internal state. The opportunities you notice, the way people perceive you, the ceiling you keep hitting - all of it is being shaped by something running inside you. This session shows you exactly what." },
