      ...
      <div className="container mx-auto px-4 py-12 lg:py-16 relative z-10">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          ...
          >
            ...
            <div className="text-white/50 text-sm font-medium mb-5">
              Today Only Free
            </div>

            <h1 className="text-4xl md:text-5xl lg:text-[3.5rem] font-extrabold text-white leading-[1.05] mb-5 tracking-tight">
              From Stuck, Underpaid, Overlooked →{" "}
              <span className="bg-gradient-to-r from-yellow-400 via-gold to-orange-400 bg-clip-text text-transparent">
                The Career You Actually Deserve
              </span>
            </h1>

            {/* BULLETS AS ROWS */}
            <div className="text-lg text-white/90 mb-7 max-w-lg leading-relaxed space-y-2">
              <p>• End the frustration</p>
              <p>• Discover what's actually blocking you</p>
              <p>• Start attracting the growth you deserve</p>
            </div>
            ...
            <div className="mb-6 grid max-w-lg grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-2xl border border-yellow-400/25 bg-white/5 p-4 backdrop-blur-sm shadow-lg">
                ...
                <p className="text-base font-bold text-white">
                  {eventInfo.time || "7:30 PM to 9:00 PM"}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 text-white/70 text-sm">
              ...
              <span>1,000+ professionals already registered · Limited seats</span>
            </div>
          </motion.div>
...
export default HeroSectionFb14;
